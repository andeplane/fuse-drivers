...
`preview-16dir.png`: all five colors rotated 22.5° per frame at 1024 px then nearest-neighbour downscaled to 64 px cells (shown 2x). This is the build-time pipeline M0 should implement; no rotation frames are generated by the model.
